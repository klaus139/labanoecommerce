        ...
        <div className='mr-[4rem] mt-[5rem]'>
            ...
            <form onSubmit={submitHandler} className='container w-auto md:w-[40rem]'>
                <div className='my-[2rem]'>
                    ...
                    <input type='text' id='name' className='mt-1 p-2 border rounded w-full' value={username} placeholder='enter your username' onChange={(e) => setUsername(e.target.value)} />
                </div>
                <div className='my-[2rem]'>
                ...
                <div className='my-[2rem]'>
                    ...
                    <input type='password' id='confirmPassword' className='mt-1 p-2 border rounded w-full' value={confirmPassword} placeholder='confirm password' onChange={(e) => setConfirmPassword(e.target.value)} />
                </div>
